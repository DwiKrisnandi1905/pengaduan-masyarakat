...
<style>
    body {
        background: url(../images/polines1.jpg);
    }
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-5">
            <h2 class="text-center text-white mb-0 mt-5">PEKAT POLINES</h2>
            <P class="text-center text-white mb-5">Pengaduan Masyarakat POLINES</P>
            <div class="card mt-5">
                <div class="card-body">
                    ...
                    <form action="{{ route('pekat.register') }}" method="POST">
                        ...
                        <div class="form-group">
                            <input type="number" name="nik" placeholder="NIM" class="form-control">
                        </div>
                        <div class="form-group">
